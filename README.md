...
> Official TypeScript/JavaScript SDK for the [CryptoPulse](https://cryptopulse.uno) API — real-time whale tracking across 17 EVM chains.
...
| `getChains()` | `GET /api/chains` | List the configured chains (whale scanning covers 17 of them) |
